...
trained_model = Actor(state_size=2, action_size=1, seed=0, fc1_units=20)
trained_model.load_state_dict(torch.load('./smooth_0.5/model_1400.pth'))
trained_model.eval()
bias_list = []
weight_list = []
...
np.savetxt('nn_accrl_relu_tanh', np.array(all_param))
print('done')